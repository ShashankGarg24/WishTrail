  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 font-manrope overflow-x-hidden">
        ...
        <section 
          ref={heroRef}
          className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-6 overflow-hidden bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-900"
        >
          {/* Background decoration */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-20 right-0 w-[500px] h-[500px] bg-blue-400/10 dark:bg-blue-500/5 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-purple-400/10 dark:bg-purple-500/5 rounded-full blur-3xl" />
          </div>
          ...
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center relative z-10">
            ...
            >
              ...
              <motion.div
                ...
                className="space-y-4"
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight font-manrope">
                  Transform Your{' '}
                ...
                <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-xl font-manrope">
              ...
              >
                ...
                <button
                  ...
                  className="group px-8 py-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white rounded-xl font-semibold text-base hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-300 flex items-center gap-2 shadow-lg"
                >
            ...
            <motion.div
              ...
              className="relative w-full max-w-14xl"
        ...
        <section className="py-20 md:py-32 px-6 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
          <div className="max-w-7xl mx-auto">
            <AnimatedSection className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-6 font-manrope">
            ...
            <div className="relative">
              <div className="flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 scrollbar-hide -mx-4 px-4 md:px-0">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-purple-50 dark:bg-purple-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-indigo-50 dark:bg-indigo-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-cyan-50 dark:bg-cyan-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-pink-50 dark:bg-pink-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-green-50 dark:bg-green-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <Edit3 className="w-7 h-7 text-green-600 dark:text-green-400" />
                      </div>
                    </div>
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-amber-50 dark:bg-amber-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 h-full shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-all duration-300 group">
                    <div className="mb-6">
                      <div className="w-14 h-14 rounded-2xl bg-orange-50 dark:bg-orange-950/50 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <section className="py-20 md:py-32 px-6 bg-white dark:bg-gray-900" id="create-goals">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-lg font-bold text-gray-900 dark:text-white font-manrope">Your Dashboard</h3>
                      <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={handleGetStarted}
                        className="flex items-center gap-2 px-4 py-2 bg-[#4c99e6] hover:bg-[#3d88d5] text-white rounded-lg transition-colors shadow-sm font-manrope font-medium text-sm"
                      >
                    ...
                    >
                      ...
                      >
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-gray-900 dark:text-white text-sm font-manrope mb-1">Learn Photography</h4>
              ...
              <AnimatedSection className="space-y-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white leading-tight font-manrope">
        ...
        <section className="py-20 md:py-32 px-6 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-900">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              {/* Left Content */}
              <AnimatedSection className="space-y-6">
                ...
                {/* Motivation Tip */}
                <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-500 rounded-lg p-5">
                  <div className="flex items-start gap-3">
                    <div>
        ...
        <section className="py-20 md:py-32 px-6 bg-white dark:bg-gray-900" id="community-feed">
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
              {/* Left Content - Feed Animation */}
              <AnimatedSection>
                <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 border border-gray-200 dark:border-gray-700 max-h-[650px] overflow-hidden">
                  {/* Feed Header */}
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white font-manrope">Growth Feed</h3>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                            <span className="font-semibold text-gray-900 dark:text-white text-sm font-manrope">Alex Chen</span>
              ...
              <AnimatedSection className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-pink-100 dark:bg-pink-900/50 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <Heart className="w-4 h-4 text-pink-600 dark:text-pink-400" />
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Real-time Updates</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">See goal completions, milestones, and wins as they happen</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Engage & Support</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Like, comment, and encourage others on their journey</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Find Your Tribe</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Follow people with similar goals and stay motivated together</p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-20 md:py-32 px-6 bg-white dark:bg-gray-900">
          <AnimatedSection className="max-w-4xl mx-auto text-center space-y-8">
            ...
            {/* Heading */}
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white leading-tight font-manrope">
              Ready to Start<br />Your Trail?
            </h2>

            {/* Description */}
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed font-manrope">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button
                onClick={handleGetStarted}
                className="group px-10 py-5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-bold text-lg shadow-2xl shadow-blue-500/40 hover:shadow-blue-500/60 transition-all duration-300 flex items-center gap-3"
              >
                Join WishTrail
