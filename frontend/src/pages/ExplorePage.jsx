          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              {(isSearching || loading) && (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {displayUsers.map((userItem, index) => (
                      <motion.div
                        ...
                        className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 border border-gray-700/50 hover:border-gray-600/50 transition-all duration-200"
                      >
                        <div className="flex items-center space-x-4 mb-4">
                          <img
                            src={userItem.avatar || '/api/placeholder/64/64'}
                            alt={userItem.name}
                            className="w-16 h-16 rounded-full border-2 border-gray-600 cursor-pointer hover:border-blue-500 transition-colors"
                        ...
                        {userItem.recentGoals && userItem.recentGoals.length > 0 && (
                          <div className="mb-4">
                            <p className="text-gray-400 text-xs mb-2">Recent Goals:</p>
                            <div className="space-y-1">
                              {userItem.recentGoals.slice(0, 2).map((goal, idx) => (
                                <div key={idx} className="flex items-center space-x-2">
                                  ...
                                  <span className="text-gray-300 text-sm truncate">{goal.title}</span>
                                </div>
                              ))}
                            </div>
                          </div>
                            ...
                            <>
                              {userItem.isFollowing ? (
                                <button
                                  ...
                                  className="flex-1 px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-xl transition-colors duration-200 text-sm font-medium flex items-center justify-center space-x-1"
                                >
                                  <UserCheck className="h-4 w-4" />
                                  <span>Following</span>
                                </button>
              ...
              <div className="w-full">
                ...
                {activities.length > 0 ? (
                        ...
                        <div className="flex items-start space-x-4">
                          <div className="relative">
                            <img
                              ...
                              className="w-12 h-12 rounded-full border-2 border-gray-600 cursor-pointer hover:border-blue-500 transition-colors"
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-6">
                              ...
                              {/* <button className="flex items-center space-x-2 px-3 py-1 rounded-lg bg-gray-700/50 text-gray-400 hover:bg-gray-600/50 hover:text-blue-400 transition-colors duration-200">
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-400 text-lg">No recent activity from friends.</p>
                    <p className="text-gray-500 text-sm mt-2">
