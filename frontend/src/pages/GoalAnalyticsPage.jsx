...
const GoalAnalyticsPage = () => {
  ...
  const analytics = useMemo(() => {
    ...
    const totalComments = goalData.comments?.count || 0
    ...
    <div className="min-h-screen pt-20 pb-24 px-4 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <Clock className={`h-8 w-8 ${analytics?.isOverdue ? 'text-red-500' : 'text-yellow-500'}`} />
            </div>
            <div className="text-3xl font-bold text-gray-900 dark:text-white mb-1">
        ...
        <motion.div
          ...
          className="glass-card-hover p-6 rounded-2xl mb-8"
        >
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="text-center p-6 bg-gradient-to-br from-red-50 to-pink-50 dark:from-red-900/10 dark:to-pink-900/10 rounded-lg border border-red-100 dark:border-red-900/30">
            ...
            <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-lg border border-blue-100 dark:border-blue-900/30">
              ...
              {analytics.timelineEvents.map((event, idx) => {
                ...
                return (
                  <div key={idx} className="relative flex gap-4">
                    <div className={`flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${colorClasses[event.color] || colorClasses.blue} relative z-10`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {analytics.habitLinks.map((habit, idx) => (
                <div
                  ...
                  className="p-4 rounded-lg bg-gradient-to-br from-yellow-50 to-orange-50 dark:from-yellow-900/10 dark:to-orange-900/10 border border-yellow-200 dark:border-yellow-800 cursor-pointer transition-all hover:shadow-lg hover:scale-[1.02] hover:border-yellow-300 dark:hover:border-yellow-700"
                >
