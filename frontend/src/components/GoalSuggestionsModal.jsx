    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-5xl h-[85vh] overflow-y-auto scrollbar-hide p-4 border border-gray-200 dark:border-gray-700 shadow-2xl"
