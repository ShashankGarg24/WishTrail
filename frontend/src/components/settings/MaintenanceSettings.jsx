    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-900/50 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#4c99e6] dark:focus:ring-blue-400 focus:border-transparent text-gray-900 dark:text-white resize-none"
          rows={4}
          disabled={loading}
        />
